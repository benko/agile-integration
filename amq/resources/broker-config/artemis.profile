...
ARTEMIS_HOME='/opt/java/amq-7.2'
ARTEMIS_INSTANCE='/Users/gregab/Documents/workspaces/projects/agile-tech/agile-integration/amq/broker'
ARTEMIS_DATA_DIR='/Users/gregab/Documents/workspaces/projects/agile-tech/agile-integration/amq/broker/data'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/Users/gregab/Documents/workspaces/projects/agile-tech/agile-integration/amq/broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/Users/gregab/Documents/workspaces/projects/agile-tech/agile-integration/amq/broker/etc/'
...
# Java Opts
JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -XX:+AggressiveOpts -XX:+UseFastAccessorMethods -Xms512M -Xmx2G -Dhawtio.realm=activemq  -Dhawtio.offline="true" -Dhawtio.role=amq -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml -Djon.id=amq"
